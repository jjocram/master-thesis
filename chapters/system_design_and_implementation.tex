...
The set of static hand gestures chose is the one of the \gls{ASL}, \textit{J} and \textit{Z} excluded because they involve a movement and a function to discriminate between a static letter and a dynamic letter is described in~\ref{TODO}.

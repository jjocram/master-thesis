...
\subsection{Thin}
The developers of \gls{ROS} encourage the creation of small executables by leaving the complexity in the dependencies. This promotes writing code reusable also in other projects.
